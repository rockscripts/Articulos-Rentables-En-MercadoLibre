 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'alex.rivera_api1.hotmail.com' :"wsalexws_api1.gmail.com" /*'monikarivera2009_api1.hotmail.com'*/;
$config['APIPassword'] = $config['Sandbox'] ? 'YR5PE8V2VGMTQVF9' : "N5U6KYH5AD7GF27J"/*'HQMGRA4EPL32PVLV'*/;
$config['APISignature'] = $config['Sandbox'] ? 'APVNpKQN1Ghz40Zu8CSqD9yPlGueAwACsr0BezD12C9-IQViZdv17IIg' :"AFcWxV21C7fd0v3bYYYRCpSSRl31ADLSXj-YuJniwuCAV0sw8d66zrU7" /*'ACSh2uDhT05u08CDNJgvlhs1hSd3Amr.b-5C174Zjf-5LWYYCR9pQiJq'*/;
